...
Options:
  ...
  --source=<dsourceurl>           The Server adress from which data can be read [default: https://gin.g-node.org]
  --gitsource=<gitdsourceurl>     The git Server adress from which data can be cloned [default: ssh://git@gin.g-node.org]
  --oauthserver=<repo>            The Server aof the repo service [default: http://gin.g-node.org]
